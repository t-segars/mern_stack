...
<body id="body">
    ...
    <p id="paragraph">
        ...
        For example, if you click <button id="button" onclick="setBackgroundColorById()">this button</button>, the background of this paragraph tag will change to blue.
    </p>
    <p>We also have a <button id="alert" onclick="getValueFromId('popup-input')">alert</button> button that will grab the text from the input below and show it in a popup.</p>
    <div>
    ...
    <p onmouseover="mouseOverFunction(this)" onclick="setBackgroundColorById('second','color')" id="second">
        Another task: This should be another feature. 
        I want to click anywhere in this paragraph tag and I want to be able to change the background color to whatever is in this input: <input type="text" id="color">.
    </p>
    <script>
        document.getElementById("button").onclick = () => 
            setBackgroundColorById("paragraph", "blue");
        document.getElementById("second").onclick = () => 
            setBackgroundColorById("second", getValueFromId("color"));
